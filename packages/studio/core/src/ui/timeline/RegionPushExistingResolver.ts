import {EmptyExec, Exec, int, isDefined, Optional} from "@moises-ai/lib-std"
import {ppqn} from "@moises-ai/lib-dsp"
import {AnyRegionBoxAdapter, BoxAdapters, TrackBoxAdapter, TrackType} from "@moises-ai/studio-adapters"
